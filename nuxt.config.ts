export default defineNuxtConfig({
    ...
    runtimeConfig: {
        ...
        globalRunRateLimitMinute:
            process.env.GLOBAL_RUN_RATE_LIMIT_MINUTE || '5',
        ...
        authLoginRateLimitMinute:
            process.env.AUTH_LOGIN_RATE_LIMIT_MINUTE || '10',
        ...
        public: {
            ...
            configDemoText:
                process.env.NUXT_PUBLIC_CONFIG_DEMO_TEXT ||
                'config-demo-not-set',
            siteUrl:
